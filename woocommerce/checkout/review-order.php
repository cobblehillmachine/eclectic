...
<?php if ( ! $is_ajax ) : ?><div id="order_review"><?php endif; ?>
	...
	<hr>
	<div class="cart-cta cart-totals">
		...
		<div class="cart-subtotal">
			<h3><?php _e( 'Cart Subtotal', 'woocommerce' ); ?></h3><h3><?php wc_cart_totals_subtotal_html(); ?></h3>
		</div>
		...
		<?php if ( WC()->cart->tax_display_cart === 'excl' ) : ?>
			...
			<?php else : ?>
				<div class="tax-total">
					...
					<h3><?php echo wc_price( WC()->cart->get_taxes_total() ); ?></h3>
				</div>
			<?php endif; ?>
		<?php endif; ?>
